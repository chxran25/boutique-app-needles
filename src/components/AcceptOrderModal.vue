            ...
            <div class="bg-blue-50 rounded-xl p-4 space-y-3 border border-blue-200">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input v-model.number="additionalCost.amount" type="number" min="0" step="0.01" placeholder="0.00"
...
const canSubmit = computed(() =>
  selectedItems.value.every(item => typeof item.item === 'string' && item.item.trim() !== '') &&
