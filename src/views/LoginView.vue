  ...
  <div class="flex justify-center items-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg">
      ...
      <form @submit.prevent="handleLogin">
          ...
          <div class="relative">
            ...
            >
              ...
              >
                ...
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-.3.984-.75 1.905-1.317 2.731M15.5 19.5l2 2" />
              </svg>
              <svg
                v-else
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.955 9.955 0 012.017-3.361M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 3l18 18" />
              </svg>
            </button>
        ...
        <!-- Error Message -->
        <p v-if="state.errorMessage" class="text-red-500 text-center mt-4">
          {{ state.errorMessage }}
        </p>
      </form>
    </div>
...
const handleLogin = async () => {
  try {
    ...
    if (response.message === 'Login successful') {
      toast.success('Welcome back!', { timeout: 2000 });
      router.push({ name: 'home' });
    } else {
      state.errorMessage = 'Invalid name, password, or phone.';
      toast.error(state.errorMessage, { timeout: 3000 });
    }
  } catch (error) {
